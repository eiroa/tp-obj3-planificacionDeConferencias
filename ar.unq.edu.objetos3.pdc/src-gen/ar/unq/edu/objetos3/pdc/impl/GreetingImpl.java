 ...
 * <ul>
 *   <li>{@link ar.unq.edu.objetos3.pdc.impl.GreetingImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GreetingImpl extends MinimalEObjectImpl.Container implements Greeting
{
  ...
  {
    return PdcPackage.Literals.GREETING;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PdcPackage.GREETING__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PdcPackage.GREETING__NAME:
        return getName();
    }
